      ...
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            <h2 className="heading">Proud to be a one of the nation best</h2>
            <p className="text_para">
             For 30 years in a row.us. news and world report has recognized us as  one of the best 
             publics hospitals in the nation and #1 in Texas.
            </p>
