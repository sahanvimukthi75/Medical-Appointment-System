          ...
          <div className=" flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[35px] leading-[40px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
                  We help patients live a healthy,longer life.
                </h1>
                <p className="text_para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Dignissimos, obcaecati rem molestiae quidem repellendus,
                  tempora voluptatibus maxime quis nulla dolorum consequuntur
                  libero officia cum qui atque.
                </p>
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">
                  ...
                  online sceduling tool to select an appointment time.
                </li>
              </ul>
              <Link to="/">
            ...
            {/*===========feature img===============*/}
            <div className="relative z-10 xl:w-[600px] flex justify-end mt-[550px] lg:mt-0">
